...
class TBinaryProtocol extends TProtocol {
  ...
  void writeByte(int? b) {
    b ??= 0;
    _byteOut.setUint8(0, b);
    trans_.write(_byteOut.buffer.asInt8List(), 0, 1);
  }
  ...
  void writeI16(int? i16) {
    ...
    trans_.write(_i16Out.buffer.asInt8List(), 0, 2);
  }
  ...
  void writeI32(int? i32) {
    ...
    trans_.write(_i32Out.buffer.asInt8List(), 0, 4);
  }

  final Int8List _i64Out = Int8List(8);
  ...
  void writeI64(int? i64) {
    ...
    trans_.write(_i64Out, 0, 8);
  }

  @override
  void writeString(String? str) {
    var bytes = Int8List.fromList(str != null ? _utf8Codec.encode(str) : []);
  ...
  void writeDouble(double? d) {
    ...
    trans_.write(_doubleOut.buffer.asInt8List(), 0, 8);
  }
  ...
  final Int8List _byteIn = Int8List(1);

  @override
  int readByte() {
    trans_.readAll(_byteIn, 0, 1);
    return _byteIn.buffer.asByteData().getUint8(0);
  }

  final Int8List _i16In = Int8List(2);

  @override
  int readI16() {
    trans_.readAll(_i16In, 0, 2);
    return _i16In.buffer.asByteData().getInt16(0);
  }

  final Int8List _i32In = Int8List(4);

  @override
  int readI32() {
    trans_.readAll(_i32In, 0, 4);
    return _i32In.buffer.asByteData().getInt32(0);
  }

  final Int8List _i64In = Int8List(8);

  @override
  int readI64() {
    trans_.readAll(_i64In, 0, 8);
    var i = Int64.fromBytesBigEndian(_i64In);
    return i.toInt();
  }

  final Int8List _doubleIn = Int8List(8);

  @override
  double readDouble() {
    trans_.readAll(_doubleIn, 0, 8);
  ...
  String _readString(int size) {
    Int8List stringIn = Int8List(size);
    trans_.readAll(stringIn, 0, size);
  ...
  Int8List readBinary() {
    int length = readI32();
    Int8List binaryIn = Int8List(length);
    trans_.readAll(binaryIn, 0, length);
    return binaryIn;
  }
}
